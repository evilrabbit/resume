...
export default class Index extends React.Component {
  ...
  scrollspy = () => {
    this.scrollSpyID = requestAnimationFrame(() => {
      ...
      if (scrollOffset > this.oss.current.offsetTop) {
        activeSection = '#oss'
      }

      if (scrollOffset > this.press.current.offsetTop) {
        activeSection = '#press'
      }
      ...
      if (scrollOffset > this.information.current.offsetTop) {
  ...
  render() {
    ...
    <div className="wrapper">
      ...
      <div className="content">
        ...
        <div id="education" ref={this.education}>
          <h3>Education</h3>
        ...
        <div id="information" ref={this.information}>
          <h3>Information</h3>
          <h2>Skills</h2>
